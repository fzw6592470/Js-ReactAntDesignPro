...
@connect(({ transDetails, loading }) => ({
  transDetails,
  loading: loading.models.transDetails,
}))
@Form.create()
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="车牌号">
              {getFieldDecorator('platNo')(<Input placeholder="请输入车牌号" />)}
            </FormItem>
          </Col>
          <Col md={8} sm={24}>
